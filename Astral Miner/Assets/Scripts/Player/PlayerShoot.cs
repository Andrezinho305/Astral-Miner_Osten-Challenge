...
public class PlayerShoot : MonoBehaviour
{
    ...
    // Bloqueia o tiro até a entrada usada para fechar o menu ser solta.
    ...
    private void FireBullet()
    {
        ...
        {
            Debug.LogError("O prefab da bala n�o possui Rigidbody2D.");
            Destroy(bullet1);
            return;
        }
    ...
    {
        _isShooting = false; // Garante que o tiro não continue enquanto bloqueado
